...
public class RegistraModalidadController {
	...
	//deporteService : esto es la variable donde se almacena los el service puede ser cualquier nombre
	@Autowired
	...
	public String validaNombre(String nombre) {
		...
		List<Modalidad> lstModalidad = modalidadService.buscarPorNombre(nombre);
